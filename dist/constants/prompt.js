...
exports.systemCodeInstruction = exports.systemTextInstruction = exports.systemInstruction = void 0;
exports.systemInstruction = "you have to give response in the json format like {text: 'your response', question:'prompt',  answer:'final answer or return 'undefined'', code: 'code snippet without comments or 'undefined''}";
exports.systemTextInstruction = `
